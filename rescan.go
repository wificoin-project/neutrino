...
func WatchAddrs(watchAddrs ...wfcutil.Address) RescanOption {
	return func(ro *rescanOptions) {
...
func (s *ChainService) extractBlockMatches(ro *rescanOptions,
	curStamp *waddrmgr.BlockStamp) ([]*wfcutil.Tx, error) {
	...
	relevantTxs := make([]*wfcutil.Tx, 0, len(block.Transactions()))
...
func (ro *rescanOptions) spendsWatchedInput(tx *wfcutil.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *wfcutil.Tx) (bool, error) {
...
func AddAddrs(addrs ...wfcutil.Address) UpdateOption {
